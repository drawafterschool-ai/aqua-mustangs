...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    bio: 'Senior Team Captain. 100 Butterfly & 200 Freestyle. Let’s bring home the Section 4AA Championship!',
...
export const INITIAL_EVENTS: TeamEvent[] = [
  {
    ...
    warmupTime: '15:45',
    description: 'Season home opener! Green & Gold spirit wear. Swimmers & divers warmup at 15:45.',
  ...
  {
    id: 'evt-2',
    title: 'Twin Cities 1-Meter Diving Invitational 🤿',
    type: 'divers_meet',
    date: '2026-08-29',
    startTime: '10:00',
    endTime: '13:30',
